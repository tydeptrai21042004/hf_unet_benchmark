#!/usr/bin/env python3
"""Create deterministic train/val/test splits for Kvasir-SEG."""
...
def _resolve_image_dir(data_root: Path) -> Path:
    candidates = [
        data_root / "processed" / "images_352",
...
def main() -> None:
    ...
    image_dir = _resolve_image_dir(data_root)
